...
import repositories.DesAgentClientRelationshipRepository
...
@Singleton
class DesAgentClientRelationshipTestController @Inject()(repository: DesAgentClientRelationshipRepository)
  extends BaseController {

  val addDesAgentClientRelationshipRecord: Action[AnyContent] = Action.async { implicit request =>
    Try {
  ...
  val removeDesAgentClientRelationshipRecord: Action[AnyContent] = Action.async { implicit request =>
    Try {
      val body = request.body.asJson
